  ...
  sections: [
    {
      ...
      experiences: [
        ...
        },
        {
          ...
          location: "Pune, India",
          description:
            "Led data pipeline development, optimized database performance, orchestrated cloud migrations, streamlined CI-CD deployment, and crafted operational reporting dashboards, delivering enhanced data reliability, reduced costs, and accelerated business insights.",
          color: "#0879bf",
        },
        {
          ...
          location: "Pune, India",
          description:
            "Conducted lectures for final year students on Machine Learning and designed a stock data prediction system using ML technique of Random Multi-Layer Perceptron.",
          color: "#0879bf",
        },
        {
